<?php
    ...
    */
    ...
    $query    = "INSERT INTO constancia (id, actividad, fecha_inicio, fecha_fin, horas, archivo, observaciones, denominacion_id, alumno_id) 
    VALUES (NULL, '". $nombre_actividad."', '".$fecha_inicio."', '".$fecha_fin."', '".$horas."', '".$archivo."', '".$observaciones."', 1, 1)";
